...
/**
 * Checkt den Input ob gültig, wenn ja schickt er diesen an FlightWindow weiter
 */
@Override
public void actionPerformed(ActionEvent arg0) {
	...
	if(portInput.getText() != null){
		if(!portInput.getText().matches("[0-9]*")) {
            JOptionPane.showMessageDialog(null, "Ungültige Port Nummer");    
            portInput.setText("");
            readyToSubmit = false;
        }else{
