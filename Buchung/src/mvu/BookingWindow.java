...
public class BookingWindow implements ActionListener{
	...
	private static String flightnrValue;
	private static String airlineValue;
	private static String planetypValue;

	/**
	 * Erstellt ein Fenster mit genauen Daten des Tickets und ermöglicht das Buchen eines jeweiligen Tickets
	 * @param fromAirport
	 * @param toAirport
	 * @param depTime
	 * @param destTime
	...
	public BookingWindow(String fromAirport, String toAirport, String depTime, String destTime, String airline, String planetyp, String flightnr){
		flightnrValue = flightnr;
		airlineValue = airline;
		planetypValue = planetyp;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(nameValue != null || lastNameValue != null|| reiheValue != null|| sitzeValue != null|| flightnrValue != null|| airlineValue != null){
			try{
				FlightWindow.dc.addPassenger(nameValue, lastNameValue, reiheValue, sitzeValue, airlineValue, flightnrValue);
			}catch(Exception exc){
				exc.printStackTrace();
			}
		}else{
			JOptionPane.showMessageDialog(null, "Bitte Felder vollständig ausfüllen!");
		}
	}
}
